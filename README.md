...
5. Pin the extension and open it from the Chrome toolbar

## Usage

1. Open the extension popup
2. Enter the focus time in minutes
3. Add websites to block, separated by commas
4. Click **Start Focus**
5. Stay away from blocked websites to avoid point penalties
6. Complete the session to earn points
7. Open the dashboard to view rewards and focus history
